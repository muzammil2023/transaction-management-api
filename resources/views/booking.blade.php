            ...
            <div class="row gx-0">
                <div class="col-lg-3 bg-dark d-none d-lg-block">
                    <a href="index.html" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                        <h1 class="m-0 text-primary text-uppercase">Al Abba</h1>
                    </a>
                </div>
                <div class="col-lg-9">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="{{ url('/booking/create') }}" class="row g-3" method="post">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="phone" class="form-control" id="phone" name="phone" placeholder="Your Contact Number">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="no_of_members" name="no_of_members" placeholder="Number Of Members">
                                        <label for="no_of_members">Number Of Members</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <label for="rooms">Select A Rooms</label>
                                        <div></div>Rooms...
                                    </div>
                                </div>
                                <div class="col-12">
